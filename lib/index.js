    ...
    _b137.m = {};
    _b137.s = function(id) {
        var result = _b137.r(id);
        if (result === undefined) {
            return require(id);
        }
    }
    _b137.r = function(id) {
        var cached = _b137.m[id];
        // resolve if in cache
        if (cached) {
...
// stricter/index.js
_b137.f[0] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
var stricter_1 = _b137.r(1);
exports.stricter = stricter_1.default;
var cli_1 = _b137.r(19);
exports.cli = cli_1.default;
var processor_1 = _b137.r(9);
exports.readFilesData = processor_1.readFilesData;
var dependencies_1 = _b137.r(10);
exports.readDependencies = dependencies_1.default;
}
// stricter/stricter.js
_b137.f[1] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const config_1 = _b137.r(2);
const rule_1 = _b137.r(6);
const processor_1 = _b137.r(9);
const logger_1 = _b137.r(15);
const utils_1 = _b137.r(7);
const types_1 = _b137.r(14);
exports.default = ({silent = false, reporter = types_1.Reporter.CONSOLE, configPath}) => {
    ...
    const projectResult = processor_1.applyProjectRules(config.root, filesData.filesData, filesData.dependencies, ruleApplications);
...
_b137.f[2] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const read_config_1 = _b137.r(3);
const process_config_1 = _b137.r(4);
const validate_config_1 = _b137.r(5);
...
_b137.f[3] = function(module,exports){
...
_b137.f[4] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_b137.f[5] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
exports.default = foundConfig => {
    if (!foundConfig) {
...
_b137.f[6] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const path = require('path');
const utils_1 = _b137.r(7);
const default_rules_1 = _b137.r(8);
...
_b137.f[7] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const fs = require('fs');
const path = require('path');
...
_b137.f[8] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_b137.f[9] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const utils_1 = _b137.r(7);
const rule_1 = _b137.r(6);
const dependencies_1 = _b137.r(10);
const types_1 = _b137.r(14);
...
exports.readFilesData = (files, root, extensions) => {
    ...
    const dependencies = dependencies_1.default(filesData, root, extensions);
    return {
        filesData,
        dependencies
    };
...
_b137.f[10] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const extract_path_1 = _b137.r(11);
const parse_imports_1 = _b137.r(13);
...
_b137.f[11] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const path = require('path');
const resolve_import_1 = _b137.r(12);
...
_b137.f[12] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const fs = require('fs');
const path = require('path');
...
_b137.f[13] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_b137.f[14] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
var Level;
(function (Level) {
...
_b137.f[15] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
var console_1 = _b137.r(16);
exports.consoleLogger = console_1.default;
var mocha_1 = _b137.r(17);
exports.mochaLogger = mocha_1.default;
var flatten_1 = _b137.r(18);
...
_b137.f[16] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_b137.f[17] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const fs = require('fs');
...
_b137.f[18] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
// stricter/cli.js
_b137.f[19] = function(module,exports){
var process = require('process');
Object.defineProperty(exports, '__esModule', { value: true });
const program = require('commander');
const isCi = require('is-ci');
const stricter_1 = _b137.r(1);
exports.default = () => {

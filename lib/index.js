...
// stricter/index.js
_93be.f[0] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
var stricter_1 = _93be.r(1);
exports.stricter = stricter_1.default;
var cli_1 = _93be.r(20);
exports.cli = cli_1.default;
var processor_1 = _93be.r(9);
exports.readFilesData = processor_1.readFilesData;
var dependencies_1 = _93be.r(10);
exports.readDependencies = dependencies_1.default;
}
// stricter/stricter.js
_93be.f[1] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const config_1 = _93be.r(2);
const rule_1 = _93be.r(6);
const processor_1 = _93be.r(9);
const logger_1 = _93be.r(15);
const utils_1 = _93be.r(7);
const types_1 = _93be.r(14);
const debug_1 = _93be.r(19);
exports.default = ({silent = false, reporter = types_1.Reporter.CONSOLE, configPath}) => {
    ...
    debug_1.default('Read config');
    const config = config_1.getConfig(configPath);
    debug_1.default('Get file list');
    const fileList = utils_1.listFiles(config.root);
    debug_1.default('Get rule definitions');
    const ruleDefinitions = rule_1.getRuleDefinitions(config);
    debug_1.default('Get rule applications');
    const ruleApplications = rule_1.getRuleApplications(config, ruleDefinitions);
    debug_1.default('Get files to process');
    const filesToProcess = rule_1.filterFilesToProcess(config.root, fileList, ruleApplications);
    debug_1.default('Read files data');
    const filesData = processor_1.readFilesData(filesToProcess, [config.root], config.extensions);
    debug_1.default('Apply rules');
    const projectResult = processor_1.applyProjectRules(config.root, filesData, ruleApplications);
    debug_1.default('Massage logs');
    const logs = logger_1.compactProjectLogs(projectResult);
    debug_1.default('Write logs');
    if (reporter === types_1.Reporter.MOCHA) {
        logger_1.mochaLogger(logs);
    } else {
        logger_1.consoleLogger(logs);
    }
    debug_1.default('Count errors');
    ...
    if (debug_1.default.enabled) {
        debug_1.default('Total time: %dms', Date.now() - now);
    }
    return result;
};
}
// stricter/config/index.js
_93be.f[2] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const read_config_1 = _93be.r(3);
const process_config_1 = _93be.r(4);
const validate_config_1 = _93be.r(5);
...
_93be.f[3] = function(module,exports){
...
_93be.f[4] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_93be.f[5] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
exports.default = foundConfig => {
    if (!foundConfig) {
...
_93be.f[6] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const path = require('path');
const utils_1 = _93be.r(7);
const default_rules_1 = _93be.r(8);
...
_93be.f[7] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const fs = require('fs');
const path = require('path');
...
_93be.f[8] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_93be.f[9] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const utils_1 = _93be.r(7);
const rule_1 = _93be.r(6);
const dependencies_1 = _93be.r(10);
const types_1 = _93be.r(14);
const readFileData = (filePath, root, extensions) => {
    ...
    const dependencies = ast ? dependencies_1.readDependencies(ast(), filePath, root, extensions) : undefined;
...
_93be.f[10] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const extract_path_1 = _93be.r(11);
const parse_imports_1 = _93be.r(13);
...
_93be.f[11] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const path = require('path');
const resolve_import_1 = _93be.r(12);
...
_93be.f[12] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const fs = require('fs');
const path = require('path');
...
_93be.f[13] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_93be.f[14] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
var Level;
(function (Level) {
...
_93be.f[15] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
var console_1 = _93be.r(16);
exports.consoleLogger = console_1.default;
var mocha_1 = _93be.r(17);
exports.mochaLogger = mocha_1.default;
var flatten_1 = _93be.r(18);
...
_93be.f[16] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
_93be.f[17] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const fs = require('fs');
...
_93be.f[18] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
...
// stricter/debug.js
_93be.f[19] = function(module,exports){
Object.defineProperty(exports, '__esModule', { value: true });
const debug = require('debug');
exports.default = debug('stricter');
}
// stricter/cli.js
_93be.f[20] = function(module,exports){
var process = require('process');
Object.defineProperty(exports, '__esModule', { value: true });
const program = require('commander');
const isCi = require('is-ci');
const stricter_1 = _93be.r(1);
exports.default = () => {
